...
<body style="background-color:grey">
    <div class="grid grid-cols-3 text-center">
            ...
            <div class="bg-green-700 text-4xl text-red-500 text text-right py-6"><b> Editar Consulta</b></div>
    </div>
        ...
        <form action="{{ route('consultas.update',$consulta->id) }}" method="post">
            ...
            <div class="md:flex md:items-center mb-6">
                ...
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                    id="diagnostico" name="diagnostico" type="text" value="{{ $consulta->diagnostico }}">
                </div>
            </div>
            <div class="md:flex md:items-center mb-6">
                <div class="md:w-1/3">
                ...
                <div class="md:w-2/3">
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                    id="receta" name="receta" type="text" value="{{ $consulta->receta }}">
                </div>
            </div>
